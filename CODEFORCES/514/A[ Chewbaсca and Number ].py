head>
    ...
    <meta name="X-Csrf-Token" content="512d1d1f51d47ff8534c3c793720ea76"/>
    ...
    <meta property="og:title" content="Submission #50071904 - Codeforces"/>
    ...
    <title>Submission #50071904 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='512d1d1f51d47ff8534c3c793720ea76'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F50071904">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='512d1d1f51d47ff8534c3c793720ea76'/>
...
l=[str(min(int(x),9-int(x)))  for x in n]
