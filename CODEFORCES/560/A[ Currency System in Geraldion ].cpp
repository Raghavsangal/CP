head>
    ...
    <meta name="X-Csrf-Token" content="17e0253eb3b4cee2f5128efc204944ee"/>
    ...
    <meta property="og:title" content="Submission #50406742 - Codeforces"/>
    ...
    <meta name="cc" content="40b0d66a19f17602583e231383d4008ceb97dc14"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50406742 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='17e0253eb3b4cee2f5128efc204944ee'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F560%2Fsubmission%2F50406742">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='17e0253eb3b4cee2f5128efc204944ee'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Currency System in Geraldion" href="/contest/560/problem/A">560A</a>
...
int main(){
int n,x,k=0;std::cin>>n;while(n--){std::cin>>x;if(x==1)k=1;}
std::cout<<((k==0)?"1":"-1");
}