head>
    ...
    <meta name="X-Csrf-Token" content="c5bf20114be081f77e9b89aa38968168"/>
    ...
    <meta property="og:title" content="Submission #51140374 - Codeforces"/>
    ...
    <meta name="cc" content="cbda5f83bad90ba6594569d45f0b120d1d080eaa"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51140374 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c5bf20114be081f77e9b89aa38968168'>&nbsp;</span>
...
<a href="/harbourspace"><img style="position:relative; bottom:6px;" src="//assets.codeforces.com/images/hsu.png"/></a>
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F915%2Fsubmission%2F51140374">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c5bf20114be081f77e9b89aa38968168'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/915">Problems</a></li>
        <li><a
                                        href="/contest/915/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/915/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/915/status">Status</a></li>
        <li><a
                                        href="/contest/915/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/915/standings">Standings</a></li>
        <li><a
                                        href="/contest/915/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Garden" href="/contest/915/problem/A">915A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n,k=list(map(int,input().split(" ")))
a=input().split(" ")
a=list(map(int,a))
l=[]
for i in range (n):
