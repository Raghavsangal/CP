head>
    ...
    <meta name="X-Csrf-Token" content="754836f54f9079100f002b4415ca40f5"/>
    ...
    <meta property="og:title" content="Submission #51166404 - Codeforces"/>
    ...
    <meta name="cc" content="a1420a17008f2481732972012f11f36a5f9cfbf0"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51166404 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='754836f54f9079100f002b4415ca40f5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F672%2Fsubmission%2F51166404">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='754836f54f9079100f002b4415ca40f5'/>
...
print(n-len(set(raw_input()))if n<27 else-1)