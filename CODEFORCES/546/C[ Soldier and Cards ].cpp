head>
    ...
    <meta name="X-Csrf-Token" content="4233733b65dfa1841bab2bdd43e14880"/>
    ...
    <meta property="og:title" content="Submission #52580484 - Codeforces"/>
    ...
    <title>Submission #52580484 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4233733b65dfa1841bab2bdd43e14880'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F546%2Fsubmission%2F52580484">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4233733b65dfa1841bab2bdd43e14880'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    ...
    <pre id="program-source-text" class="prettyprint lang-cpp program-source" style="padding: 0.5em;">//   *BY: Raghav Sangal
#include<bits/stdc++.h>
using namespace std;
int main(){
    int n,a,b,c=0;
    ...
    while(!q1.empty() and !q2.empty() and c<=106){
        a=q1.front();
        b=q2.front();
        q1.pop();
        q2.pop();
