head>
    ...
    <meta name="X-Csrf-Token" content="4a5b8fa3985f91fe29e2f230fe5f0787"/>
    ...
    <meta property="og:title" content="Submission #51869631 - Codeforces"/>
    ...
    <meta name="cc" content="ccd539b124e0779cc4a1a474d3d4be38d6ea30ef"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51869631 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4a5b8fa3985f91fe29e2f230fe5f0787'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F379%2Fsubmission%2F51869631">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4a5b8fa3985f91fe29e2f230fe5f0787'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - New Year Candles" href="/contest/379/problem/A">379A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">a,b=map(int,input().split())
print(a+(a-1)//(b-1))