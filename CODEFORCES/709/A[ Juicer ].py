head>
    ...
    <meta name="X-Csrf-Token" content="1003b6344209eda5e5ad2920ab875e04"/>
    ...
    <meta property="og:title" content="Submission #51139569 - Codeforces"/>
    ...
    <meta name="cc" content="e275418f7638b5b18a5784ad86aa81acaed9dea5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51139569 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1003b6344209eda5e5ad2920ab875e04'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    <div style="float:left;">
            <div><a href="/aimtech2016"><img src="//assets.codeforces.com/images/aimtech-logo.png" style="width:180px;"/></a></div>
    </div>
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F709%2Fsubmission%2F51139569">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1003b6344209eda5e5ad2920ab875e04'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n,b,d=list(map(int,input().split(" ")))
a=input().split(" ")
a=list(map(int,a))
sum=0
c=0
