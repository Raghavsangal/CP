head>
    ...
    <meta name="X-Csrf-Token" content="d3b03eac870517829c93b441c618027d"/>
    ...
    <meta property="og:title" content="Submission #50361342 - Codeforces"/>
    ...
    <meta name="cc" content="0d5e6504a868ae7d5f18b87c979fda900f3b5a25"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50361342 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d3b03eac870517829c93b441c618027d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F20%2Fsubmission%2F50361342">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d3b03eac870517829c93b441c618027d'/>
...
long long dis[100010],node[100010];
...
int main()
{
	...
	if(dis[n]==1000000000000000000) cout<<"-1\n";
	else{
		printpath(n);
		cout<<"\n";
	}
