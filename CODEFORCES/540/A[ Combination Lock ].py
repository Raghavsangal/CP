head>
    ...
    <meta name="X-Csrf-Token" content="d142e46e56d700b164b246d49bbbef23"/>
    ...
    <meta property="og:title" content="Submission #51830739 - Codeforces"/>
    ...
    <meta name="cc" content="602466074997d388a9271e3247fb391d7f11c416"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51830739 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d142e46e56d700b164b246d49bbbef23'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F540%2Fsubmission%2F51830739">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d142e46e56d700b164b246d49bbbef23'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">input();print(sum(min(abs(x-y),10-abs(x-y)) for x,y in zip(map(int,input()),map(int,input()))))