head>
    ...
    <meta name="X-Csrf-Token" content="f8fbf910b19f8d94345b9cf1a686c383"/>
    ...
    <meta property="og:title" content="Submission #50459798 - Codeforces"/>
    ...
    <meta name="cc" content="0aa20ba707a01206a3ed2cd425d709dcbf19a138"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50459798 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f8fbf910b19f8d94345b9cf1a686c383'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F320%2Fsubmission%2F50459798">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f8fbf910b19f8d94345b9cf1a686c383'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/320">Problems</a></li>
        <li><a
                                        href="/contest/320/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/320/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/320/status">Status</a></li>
        <li><a
                                        href="/contest/320/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/320/room/1">Room</a></li>
        <li><a
                                        href="/contest/320/standings">Standings</a></li>
        <li><a
                                        href="/contest/320/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Magic Numbers" href="/contest/320/problem/A">320A</a>
...
for(int i=0;i<s.size();i++){
    if((s[i]==&#39;1&#39;)||(s[i]==&#39;4&#39;&&s[i-1]==&#39;1&#39;)||(s[i-2]==&#39;1&#39;&&s[i-1]==&#39;4&#39;&&s[i]==&#39;4&#39;)){
        // continue;
        flag=1;
    }
    else{
