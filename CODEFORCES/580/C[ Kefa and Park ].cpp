head>
    ...
    <meta name="X-Csrf-Token" content="73c0ad53fe8a2ebd90dc053f10b11b61"/>
    ...
    <meta property="og:title" content="Submission #50270071 - Codeforces"/>
    ...
    <meta name="cc" content="80f21f73ea0b5d2dd4f1ab304b869dd7831355fe"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50270071 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='73c0ad53fe8a2ebd90dc053f10b11b61'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F50270071">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='73c0ad53fe8a2ebd90dc053f10b11b61'/>
...
int n,m,i,ans,c[N],x,y;
vector <int> v[N];

void dfs(int vx, int pr, int sum){
	if(sum>m)return;
	for(int i=0;i<v[vx].size();i++){
		if(v[vx][i]!=pr){
			if(c[v[vx][i]]==0)dfs(v[vx][i],vx,0);
			else dfs(v[vx][i],vx,sum+1);
		}
	}
	if(v[vx].size()==1 && pr!=0)ans++;
}
