head>
    ...
    <meta name="X-Csrf-Token" content="f5ad9cebc023413dcf6ac8ae81ef503d"/>
    ...
    <meta property="og:title" content="Submission #50677017 - Codeforces"/>
    ...
    <meta name="cc" content="2470981b50ea9d235d2dfa92e2de074094bad30a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50677017 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f5ad9cebc023413dcf6ac8ae81ef503d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F688%2Fsubmission%2F50677017">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f5ad9cebc023413dcf6ac8ae81ef503d'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Opponents" href="/contest/688/problem/A">688A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n, d = map(int, raw_input().split())
cur = 0
ans = 0
for i in range(d):
    s = raw_input()
