head>
    ...
    <meta name="X-Csrf-Token" content="6cc370f3252ef2e7cb3d150ed6e0c278"/>
    ...
    <meta property="og:title" content="Submission #51831062 - Codeforces"/>
    ...
    <meta name="cc" content="62c346ce047a8744d68024f10e8a257ae3e00ce8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51831062 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6cc370f3252ef2e7cb3d150ed6e0c278'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F581%2Fsubmission%2F51831062">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6cc370f3252ef2e7cb3d150ed6e0c278'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Vasya the Hipster" href="/contest/581/problem/A">581A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">a,b=sorted(map(int,input().split()))
print(a,(b-a)//2)