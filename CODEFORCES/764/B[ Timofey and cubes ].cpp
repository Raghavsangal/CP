head>
    ...
    <meta name="X-Csrf-Token" content="325c2bfcc829636c79f8f9ca77ec03da"/>
    ...
    <meta property="og:title" content="Submission #52583872 - Codeforces"/>
    ...
    <meta name="cc" content="b9ddf6969bc77ab1f1115585c2b63d6a58826c5b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52583872 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='325c2bfcc829636c79f8f9ca77ec03da'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F764%2Fsubmission%2F52583872">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='325c2bfcc829636c79f8f9ca77ec03da'/>
...
int main()
{
	...
	for(i=1;i<=n/2;i+=2)swap(a[i],a[n-i+1]);
