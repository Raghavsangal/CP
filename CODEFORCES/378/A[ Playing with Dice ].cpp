head>
    ...
    <meta name="X-Csrf-Token" content="cd003e90b99c3cc78ffe36eb21035510"/>
    ...
    <meta property="og:title" content="Submission #50464482 - Codeforces"/>
    ...
    <meta name="cc" content="f25e3bc158511701a3b48ff5e1522a88d4709210"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50464482 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cd003e90b99c3cc78ffe36eb21035510'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F378%2Fsubmission%2F50464482">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cd003e90b99c3cc78ffe36eb21035510'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/378">Problems</a></li>
        <li><a
                                        href="/contest/378/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/378/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/378/status">Status</a></li>
        <li><a
                                        href="/contest/378/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/378/room/1">Room</a></li>
        <li><a
                                        href="/contest/378/standings">Standings</a></li>
        <li><a
                                        href="/contest/378/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Playing with Dice" href="/contest/378/problem/A">378A</a>
...
int main()
{
	...
	for(int i=1;i<=6;i++)
	{
		if(abs(n-i)<abs(m-i)) k++;
		else if(abs(n-i)>abs(m-i)) k1++;
		else k2++;
	}
	cout<<k<<" "<<k2<<" "<<k1;
}