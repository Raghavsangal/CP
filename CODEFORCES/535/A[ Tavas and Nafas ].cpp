head>
    ...
    <meta name="X-Csrf-Token" content="ba49bfe629014551216167c1087b2ca4"/>
    ...
    <meta property="og:title" content="Submission #52472509 - Codeforces"/>
    ...
    <meta name="cc" content="c0ab67f00a2c86546dc8cbb4363dae936eab5013"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52472509 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ba49bfe629014551216167c1087b2ca4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F535%2Fsubmission%2F52472509">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ba49bfe629014551216167c1087b2ca4'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Tavas and Nafas" href="/contest/535/problem/A">535A</a>
...
main(){
	cin>>n;
	if(n<20)cout<<a[n];
	else if(n%10==0)cout<<b[n/10];
	else cout<<b[n/10]<<"-"<<a[n%10];
}