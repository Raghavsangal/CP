head>
    ...
    <meta name="X-Csrf-Token" content="c675f36961017696b66ff5ca400b21d4"/>
    ...
    <meta property="og:title" content="Submission #52021259 - Codeforces"/>
    ...
    <meta name="cc" content="19ff84ce9bd9db494e9d186e086f8865bd2ba15a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52021259 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c675f36961017696b66ff5ca400b21d4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F841%2Fsubmission%2F52021259">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c675f36961017696b66ff5ca400b21d4'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/841">Problems</a></li>
        <li><a
                                        href="/contest/841/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/841/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/841/status">Status</a></li>
        <li><a
                                        href="/contest/841/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/841/room/1">Room</a></li>
        <li><a
                                        href="/contest/841/standings">Standings</a></li>
        <li><a
                                        href="/contest/841/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Generous Kefa" href="/contest/841/problem/A">841A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">a,c=map(int,input().split())
b=input()
for i in b:
	if b.count(i)>c:
		print(&#39;NO&#39;)
