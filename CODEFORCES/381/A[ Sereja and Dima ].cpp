head>
    ...
    <meta name="X-Csrf-Token" content="4fd6e85693b04c11fce876507c7101b4"/>
    ...
    <meta property="og:title" content="Submission #50402371 - Codeforces"/>
    ...
    <meta name="cc" content="2644fd6c09778ca9a9b7470191515147048a6baf"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50402371 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4fd6e85693b04c11fce876507c7101b4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F381%2Fsubmission%2F50402371">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4fd6e85693b04c11fce876507c7101b4'/>
...
using namespace std;
int main(){
	int i,srj=0,dmn=0,size,max;
	scanf("%d",&size);
	int a[size];
	for(i=0;i<size;++i)
		scanf("%d",&a[i]);	
	i=0; int j=size-1,cnt=0;
	while(i<=j){
		if(a[i]>a[j])
		{	
			max=a[i];
