head>
    ...
    <meta name="X-Csrf-Token" content="2c5f55333f873e07c3a389ab3c495a4d"/>
    ...
    <meta property="og:title" content="Submission #50053114 - Codeforces"/>
    ...
    <meta name="cc" content="386ef40f7668582e7acca7a0f7543a34d2b087bc"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50053114 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2c5f55333f873e07c3a389ab3c495a4d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F349%2Fsubmission%2F50053114">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2c5f55333f873e07c3a389ab3c495a4d'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/349">Problems</a></li>
        <li><a
                                        href="/contest/349/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/349/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/349/status">Status</a></li>
        <li><a
                                        href="/contest/349/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/349/room/1">Room</a></li>
        <li><a
                                        href="/contest/349/standings">Standings</a></li>
        <li><a
                                        href="/contest/349/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Cinema Line" href="/contest/349/problem/A">349A</a>
...
using namespace std;
int a,b,c,d,e,f,g,x[100000];
int main()
{
	cin>>a;
	for(b=1;b<=a;b++){cin>>x[b];if(x[b]==25)c++;else if(x[b]==50){d++;c--;
	}else if(x[b]==100&&d>0){e++;d--;c--;
	}else if(x[b]==100){e++;c=c-3;
	}
	if(c<0){cout<<"NO";f++;break;
