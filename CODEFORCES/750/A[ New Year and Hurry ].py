head>
    ...
    <meta name="X-Csrf-Token" content="9cb0cd059f3afc1b4145cd920fa88e5b"/>
    ...
    <meta property="og:title" content="Submission #51831070 - Codeforces"/>
    ...
    <meta name="cc" content="d90f7a08f46ede4d98dc92e94529d85b51f7563b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51831070 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9cb0cd059f3afc1b4145cd920fa88e5b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F750%2Fsubmission%2F51831070">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9cb0cd059f3afc1b4145cd920fa88e5b'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - New Year and Hurry" href="/contest/750/problem/A">750A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n,k=map(int,input().split())
