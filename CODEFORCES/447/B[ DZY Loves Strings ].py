head>
    ...
    <meta name="X-Csrf-Token" content="4cbcc413c9fed73b16ee615f211e2692"/>
    ...
    <meta property="og:title" content="Submission #51051459 - Codeforces"/>
    ...
    <meta name="cc" content="d8b023fb40ffcf99f4fd568829161b067583b947"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #51051459 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4cbcc413c9fed73b16ee615f211e2692'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F447%2Fsubmission%2F51051459">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4cbcc413c9fed73b16ee615f211e2692'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="B - DZY Loves Strings" href="/contest/447/problem/B">447B</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n=input()
k=int(input())
q=input().split(" ")
q=list(map(int,q))
# q.sort(reverse=True)
