head>
    ...
    <meta name="X-Csrf-Token" content="05c117fbd48ed68ab4209733744d8c15"/>
    ...
    <meta property="og:title" content="Submission #52244000 - Codeforces"/>
    ...
    <meta name="cc" content="0979d6d6d70e1d54551907aabf79803292949052"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52244000 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='05c117fbd48ed68ab4209733744d8c15'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F509%2Fsubmission%2F52244000">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='05c117fbd48ed68ab4209733744d8c15'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Maximum in Table" href="/contest/509/problem/A">509A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-cpp program-source" style="padding: 0.5em;">#import<cstdio>
int i,n,p=1;main(){for(scanf("%d",&n),n--;i++<n;)p=p*(2*n-i+1)/i;printf("%d",p);}