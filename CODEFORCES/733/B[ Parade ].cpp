head>
    ...
    <meta name="X-Csrf-Token" content="76af169f506dc35281fb0643684bcf2b"/>
    ...
    <meta property="og:title" content="Submission #52321494 - Codeforces"/>
    ...
    <meta name="cc" content="e21361576d3786ab3709a5e826656e07c4becf8a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52321494 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='76af169f506dc35281fb0643684bcf2b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F733%2Fsubmission%2F52321494">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='76af169f506dc35281fb0643684bcf2b'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="B - Parade" href="/contest/733/problem/B">733B</a>
...
for(int i=0;i<n;i++){
    swap_l=p[i].first;
    swap_r=p[i].second;
    // cout << swap_l << " "<< swap_r<< endl;
    int new_l=sum_l+swap_r-swap_l;
    // cout << new_l<<endl;
    int new_r=sum_r+swap_l-swap_r;
    // cout << new_r<< endl;
    k=abs(new_l-new_r);
    // cout << k << endl;
    if(sum<k){
