head>
    ...
    <meta name="X-Csrf-Token" content="398a5ccf8e7d6344800b13e0fe8d231e"/>
    ...
    <meta property="og:title" content="Submission #52542322 - Codeforces"/>
    ...
    <meta name="cc" content="2917eb92a74ca5aeb4385510022d280eadaabbc3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52542322 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='398a5ccf8e7d6344800b13e0fe8d231e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F377%2Fsubmission%2F52542322">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='398a5ccf8e7d6344800b13e0fe8d231e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/377">Problems</a></li>
        <li><a
                                        href="/contest/377/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/377/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/377/status">Status</a></li>
        <li><a
                                        href="/contest/377/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/377/room/1">Room</a></li>
        <li><a
                                        href="/contest/377/standings">Standings</a></li>
        <li><a
                                        href="/contest/377/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Maze" href="/contest/377/problem/A">377A</a>
         - <span title="problem revision">65</span>
    </td>
    <td>
    GNU C++14
    </td>
...
int row[] = {0, -1, 0, 1};
int col[] = {-1, 0, 1, 0};
int n,m,k,a,b,c=0,total;
vector<vector<char>> v;
bool visited[500][500];
bool valid(int t,int u){
    if(t>=n or u>=m or t<0 or u<0 or visited[t][u] or v[t][u]==&#39;#&#39; ){
        return false;
    }
    return true;
}
