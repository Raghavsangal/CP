head>
    ...
    <meta name="X-Csrf-Token" content="ddfc1b4f2b61d226ed693bc9a0d28a82"/>
    ...
    <meta property="og:title" content="Submission #50154317 - Codeforces"/>
    ...
    <meta name="cc" content="59be35a63a8418d9e71b5f400ba302a146d8a0e9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50154317 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ddfc1b4f2b61d226ed693bc9a0d28a82'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F37%2Fsubmission%2F50154317">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ddfc1b4f2b61d226ed693bc9a0d28a82'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/37">Problems</a></li>
        <li><a
                                        href="/contest/37/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/37/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/37/status">Status</a></li>
        <li><a
                                        href="/contest/37/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/37/room/1">Room</a></li>
        <li><a
                                        href="/contest/37/standings">Standings</a></li>
        <li><a
                                        href="/contest/37/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Towers" href="/contest/37/problem/A">37A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">from collections import Counter
n=int(input())
a=input().split(" ")
a=list(map(int,a))
c=Counter(a)
