head>
    ...
    <meta name="X-Csrf-Token" content="9942db358729b130f630452a05adf7e1"/>
    ...
    <meta property="og:title" content="Submission #49999679 - Codeforces"/>
    ...
    <meta name="cc" content="1cf956235c21461c4117b5eb062d8f9cc0022595"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #49999679 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9942db358729b130f630452a05adf7e1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F731%2Fsubmission%2F49999679">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9942db358729b130f630452a05adf7e1'/>
...
for(i=0;i<s.size();i++)
{
    count+=min(abs(ch-s[i]),26-abs(ch-s[i]));
