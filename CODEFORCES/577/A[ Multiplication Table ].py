head>
    ...
    <meta name="X-Csrf-Token" content="1e285ed1c4365f9780f86706bae0de5b"/>
    ...
    <meta property="og:title" content="Submission #52243891 - Codeforces"/>
    ...
    <meta name="cc" content="fd7f6710bce74bf49911feda7970c53923094683"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52243891 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1e285ed1c4365f9780f86706bae0de5b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F577%2Fsubmission%2F52243891">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1e285ed1c4365f9780f86706bae0de5b'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Multiplication Table" href="/contest/577/problem/A">577A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n,x=map(int,input().split())
