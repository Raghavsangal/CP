head>
    ...
    <meta name="X-Csrf-Token" content="3ed55852e5f026879a4bf16f4e40c925"/>
    ...
    <meta property="og:title" content="Submission #50501219 - Codeforces"/>
    ...
    <meta name="cc" content="23939c7279f803fd3ce83a01cc957ba2e9c516e6"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50501219 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3ed55852e5f026879a4bf16f4e40c925'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F50501219">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3ed55852e5f026879a4bf16f4e40c925'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">I=lambda:sorted(map(int,input().split()))
n=I()[0]
a=I()
m=I()[0]
b=I()
