head>
    ...
    <meta name="X-Csrf-Token" content="5be737301d0634f87cb69a9447086e8c"/>
    ...
    <meta property="og:title" content="Submission #52247623 - Codeforces"/>
    ...
    <meta name="cc" content="8242f3a16b76edde1a6083f9d3cbf5922bb00698"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52247623 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5be737301d0634f87cb69a9447086e8c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F609%2Fsubmission%2F52247623">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5be737301d0634f87cb69a9447086e8c'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/609">Problems</a></li>
        <li><a
                                        href="/contest/609/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/609/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/609/status">Status</a></li>
        <li><a
                                        href="/contest/609/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/609/standings">Standings</a></li>
        <li><a
                                        href="/contest/609/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - USB Flash Drives" href="/contest/609/problem/A">609A</a>
    ...
    <td>2019-04-02 23:11:17</td>
    <td>2019-04-02 23:11:18</td>
    <td>
...
int main()
{
int n,size;cin>>n>>size;int a[n];for(int i=0;i<n;i++)cin>>a[i];
sort(a,a+n);
int j=n-1,sum=0,c=0;
while(sum<size){c++; sum+=a[j];j--;}cout<<c;
return 0;}