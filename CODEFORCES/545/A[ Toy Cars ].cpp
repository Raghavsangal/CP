head>
    ...
    <meta name="X-Csrf-Token" content="f9684a98a4fa197d7a0fe630d19a1214"/>
    ...
    <meta property="og:title" content="Submission #52474320 - Codeforces"/>
    ...
    <meta name="cc" content="927439f4aeaae47ecfb239684d2d9d9623b88d1e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #52474320 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f9684a98a4fa197d7a0fe630d19a1214'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F545%2Fsubmission%2F52474320">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f9684a98a4fa197d7a0fe630d19a1214'/>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Toy Cars" href="/contest/545/problem/A">545A</a>
    ...
    <td>2019-04-07 23:58:11</td>
    <td>2019-04-07 23:58:12</td>
    <td>
...
long long int n, /*a[maxN][maxN]*/ a, k, b[maxN] ;
int main() 
{
	cin >> n ;
	for (int i=0; i<n; i++) 
