head>
    ...
    <meta name="X-Csrf-Token" content="a74cf44efe02c634bffd8a7cc83482b8"/>
    ...
    <meta property="og:title" content="Submission #50862823 - Codeforces"/>
    ...
    <meta name="cc" content="b167b578370163eeb6643b7b77fdca9c3c2cff1b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #50862823 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a74cf44efe02c634bffd8a7cc83482b8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F454%2Fsubmission%2F50862823">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a74cf44efe02c634bffd8a7cc83482b8'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/454">Problems</a></li>
        <li><a
                                        href="/contest/454/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/454/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/454/status">Status</a></li>
        <li><a
                                        href="/contest/454/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/454/room/1">Room</a></li>
        <li><a
                                        href="/contest/454/standings">Standings</a></li>
        <li><a
                                        href="/contest/454/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/raghavsinghal11" title="Newbie raghavsinghal11" class="rated-user user-gray">raghavsinghal11</a>    </td>
    <td>
        <a title="A - Little Pony and Crystal Mine" href="/contest/454/problem/A">454A</a>
    ...
    <pre id="program-source-text" class="prettyprint lang-py program-source" style="padding: 0.5em;">n=int(input())
k=n
l=1
d=n-1
j=n-2
...
for i in range(n):
    if(k>0):
        q.append("*"*int((k-1)/2) + "D"*l + "*"*int((k-1)/2))
        print("*"*int((k-1)/2) + "D"*l + "*"*int((k-1)/2))
        l=l+2
        k=k-2
    if(k<=0 and len(q)>=0):
        q.pop()
